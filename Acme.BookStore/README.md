...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p bb51eee2-c3b8-49d2-a3de-292492d6b048
```

> `bb51eee2-c3b8-49d2-a3de-292492d6b048` is the password of the certificate, you can change it to any password you want.
